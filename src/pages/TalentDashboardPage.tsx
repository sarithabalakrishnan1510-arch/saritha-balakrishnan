...
export const TalentDashboardPage: React.FC = () => {
  ...
  if (!currentUser) {
    return (
      <div className="max-w-md mx-auto px-4 py-20 text-center space-y-4">
        <div className="w-14 h-14 rounded-2xl bg-rose-600/20 border border-rose-500/30 flex items-center justify-center mx-auto text-rose-400">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 pt-2">
          <button
            ...
            className="w-full sm:w-auto px-4 py-2 rounded-xl bg-rose-600 text-white text-xs font-semibold shadow hover:bg-rose-500 flex items-center justify-center gap-1.5"
          >
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      {/* Top Welcome Header */}
      <div className="rounded-2xl bg-gradient-to-r from-[#141620] via-zinc-900 to-black border border-white/10 p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-6 shadow-xl">
        <div className="flex items-center gap-4">
          <img
            ...
            className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl object-cover ring-2 ring-rose-500/30"
          />
        ...
        <div className="p-4 rounded-xl bg-black/50 border border-white/10 sm:w-64 space-y-2">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            {scoredRoles.map(({ role, call, score, match }) => (
              <div
                key={role.id}
                className="rounded-xl bg-[#12141c] border border-white/10 p-5 hover:border-rose-500/40 transition-all flex flex-col md:flex-row md:items-center justify-between gap-4 text-xs shadow-lg"
              >
                <div className="space-y-2 flex-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span className="text-[11px] capitalize text-rose-300">
                ...
                <div className="flex items-center gap-3 shrink-0">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-rose-600 hover:bg-rose-500 text-white font-semibold text-xs transition-colors shadow"
                  >
                    1-Click Apply
                  </button>
                </div>
            ...
            <div className="space-y-3">
              {myApplications.map(app => {
                ...
                return (
                  <div
                    key={app.id}
                    className="p-4 rounded-xl bg-[#12141c] border border-white/10 space-y-3 text-xs"
                  >
            ...
            <div className="space-y-4">
              {myAuditions.map(aud => {
                ...
                return (
                  <div
                    key={aud.id}
                    className="p-5 rounded-2xl bg-[#141620] border border-white/10 space-y-4 text-xs shadow-lg"
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                      <div>
                    ...
                    {aud.talent_self_tape_url ? (
                      ...
                      <div className="pt-2 flex items-center gap-2">
                        {activeAuditionSubmission === aud.id ? (
                          <div className="w-full space-y-2 p-3 rounded-xl bg-black/60 border border-white/10">
                            ...
                            <input
                              ...
                              className="w-full bg-zinc-900 border border-white/15 rounded-lg px-3 py-1.5 text-xs text-white"
                            />
                            <textarea
                              rows={2}
                            ...
                            <div className="flex justify-end gap-2">
                              ...
                              <button
                                ...
                                className="px-4 py-1 rounded bg-rose-600 hover:bg-rose-500 text-white font-semibold"
                              >
                                Submit Video
                              </button>
                            </div>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <button
                              ...
                              className="px-4 py-1.5 rounded-lg bg-rose-600 hover:bg-rose-500 text-white font-semibold text-xs flex items-center gap-1.5"
                            >
      ...
      {activeTab === 'profile' && (
        <form onSubmit={handleSaveProfile} className="max-w-2xl p-6 rounded-2xl bg-[#12141c] border border-white/10 space-y-4 text-xs">
          <div className="flex items-center justify-between pb-3 border-b border-white/10">
            <h3 className="text-base font-bold text-white font-cinematic">Quick Profile Editor</h3>
            {profileSaved && (
          ...
          <div className="pt-2 text-right">
            <button
              type="submit"
              className="px-6 py-2 rounded-xl bg-rose-600 hover:bg-rose-500 text-white font-semibold text-xs shadow flex items-center gap-1.5 ml-auto"
            >
